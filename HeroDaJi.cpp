...
//    this->setHpBar(HP::create(HEALTH, this->getHpLim(), 0));
//    this->setEnergyBar(HP::create(ENERGY, this->getEnergyLim(), getEnergyRecoverRate()));
//    this->setCamp(camp);
...
//    // 创建一个 Label 用于显示等级
//    this->label = Label::createWithTTF(std::to_string(level), "fonts/Marker Felt.ttf", 24);
//
//    // 设置 Label 的位置
//    label->setPosition(Vec2(Vec2(this->getContentSize().width / 2,
...
//    animFrames.pushBack(SpriteFrame::create("DaJiright1.png", Rect(0, 0, 430, 430))); // 添加帧
//    animFrames.pushBack(SpriteFrame::create("DaJiright2.png", Rect(0, 0, 430, 430))); // 添加帧
//    animFrames.pushBack(SpriteFrame::create("DaJiright3.png", Rect(0, 0, 430, 430))); // 添加帧
//    animFrames.pushBack(SpriteFrame::create("DaJiright4.png", Rect(0, 0, 430, 430))); // 添加帧
...
//    //animAttackFrames.pushBack(SpriteFrame::create("DaJiAttackright1.png", Rect(0, 0, 400, 400))); // 添加帧
//    animAttackFrames.pushBack(SpriteFrame::create("DaJiAttackright2.png", Rect(0, 0, 400, 400))); // 添加帧
//    animAttackFrames.pushBack(SpriteFrame::create("DaJiAttackright3.png", Rect(0, 0, 400, 400))); // 添加帧
...
//    this->setHpBar(HP::create(HEALTH, this->getHpLim(), 0));
//    this->setEnergyBar(HP::create(ENERGY, this->getEnergyLim(), getEnergyRecoverRate() * 2));
//
//    this->addChild(this->getHpBar());
//    this->getHpBar()->setPosition(Vec2(this->getContentSize().width / 2, this->getContentSize().height + 0));
//
...
bool HeroDaJi::init(Ecamp camp, Ref* scene)
{
    ...
    this->setEnergyRecoverRate(mageEnergyRecoverRate);
    this->setHpBar(HP::create(HEALTH, this->getHpLim(), 0, camp));
    this->setEnergyBar(HP::create(ENERGY, this->getEnergyLim(), getEnergyRecoverRate(), camp));
